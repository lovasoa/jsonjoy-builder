...
export const es: Translation = {
  ...
  schemaTypeRef: "Referencia",
  refDescription: "Reutiliza otro esquema definido en este documento",
  refTargetLabel: "Destino de la referencia",
  refTargetPlaceholder: "#/$defs/ejemplo",
  refSelectTarget: "Seleccionar definición",
  refRootLabel: "Raíz del documento",
  refNoDefinitions: "Aún no hay definiciones en este documento",
  refBrokenWarning:
  ...
  definitionAddButton: "Añadir definición",
  definitionNamePlaceholder: "p. ej. direccion, vehiculo",
  definitionNameExists: "Ya existe una definición con este nombre",
  definitionBadge: "definición",
