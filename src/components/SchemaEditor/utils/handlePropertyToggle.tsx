import { removeObjectProperty, updateObjectProperty } from "../../../lib/schemaEditor.ts";
import { isBooleanSchema } from "../../../types/jsonSchema";
import type { ObjectJSONSchema } from "../../../types/jsonSchema.ts";

// Handle toggling between properties and patternProperties
const handlePropertyToggle = (onChange: (newSchema: ObjectJSONSchema) => void, schema: ObjectJSONSchema, name: string, isPatternProperty = false) => {
