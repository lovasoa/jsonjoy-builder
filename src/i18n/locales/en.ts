...
export const en: Translation = {
  ...
  refDescription: "Reuses another schema defined in this document",
  refTargetLabel: "Reference target",
  refTargetPlaceholder: "#/$defs/example",
  refSelectTarget: "Select definition",
  refRootLabel: "Document root",
  refNoDefinitions: "No definitions in this document yet",
  refBrokenWarning:
  ...
  definitionAddButton: "Add Definition",
  definitionNamePlaceholder: "e.g. address, vehicle",
  definitionNameExists: "A definition with this name already exists",
